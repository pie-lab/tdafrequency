...
apa_table(serps_bonferroni_ttests$p.value, caption = "P-values of Bonferroni-corrected t-tests comparing mean descriptor SERPs count by person-word.", placement = "h")
```
...
apa_table(ngrams_bonferroni_ttests$p.value,
          caption = "P-values of Bonferroni-corrected t-tests comparing mean descriptor ngrams frequency by person-word.",
          placement= "h")
```
